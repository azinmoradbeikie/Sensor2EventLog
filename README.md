...
|---|---|---|
| 0 | [`tutorials/level_0_concepts/`](tutorials/level_0_concepts/) | What an event log is, why raw sensor data isn't one, tiny raw-data-to-event-log example. *(in progress)* |
...
<!-- TODO: no LICENSE file currently exists in this repository. Add one (e.g. MIT, Apache-2.0) and update this
     section and CITATION.cff to match. -->
License to be added.
